    ...
    <Layout>
      ...
      <Layout className="site-layout">
        ...
        <main className="main">
          ...
          <div className="post_academic_calender-section">
            <h1>Post_Academic_Calender</h1>
            <form>
              <label htmlFor="post_academic_calender">
                Academic_Calender:
              </label>
              <br />
              <textarea
                id="post_academic_calender"
                name="Post_Academic_Calender"
                rows="10"
                cols="80"
              ></textarea>
              <br />
              <br />
              <button type="submit" className="bg-blue-500 hover:bg-green-700 w-10">Post</button>
            </form>
          </div>
          <br />
        </main>
...
export default A_Academic_Calender;
