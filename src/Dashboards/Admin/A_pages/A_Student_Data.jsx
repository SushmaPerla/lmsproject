              ...
              <table className="border-collapse border border-slate-500 mt-3 ml-2 bg-gray-400">
                <thead>
                  <tr>
                    ...
                    <th className="border border-slate-600 p-3">Branch</th>
                    <th className="border border-slate-600 p-3">Year</th>
                    <th className="border border-slate-600 p-3">Guide_Name</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
