              ...
              <table className="border-collapse border border-slate-500 mt-3 ml-2 bg-gray-400">
                <thead>
                  <tr>
                    ...
                    <th className="border border-slate-600 p-3">Department</th>
                    <th className="border border-slate-600 p-3">Designation</th>
                    <th className="border border-slate-600 p-3">
                      Year_of_Join
                    </th>
                    <th className="border border-slate-600 p-3">Email_ID</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
