              ...
              <table className="border-collapse border border-slate-500 mt-3 ml-2 bg-gray-400">
                <thead>
                  <tr>
                    ...
                    <th className="border border-slate-600 p-3">Bus_Stop</th>
                    <th className="border border-slate-600 p-3">Bus_Number</th>
                    <th className="border border-slate-600 p-3">Bus_Driver</th>
